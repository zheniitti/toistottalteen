...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) => appStateNotifier.loggedIn ? PaasivuWithPageviewWidget() : GetStartedSivuWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn ? PaasivuWithPageviewWidget() : GetStartedSivuWidget(),
          routes: [
            FFRoute(
              name: 'tilastot_sivu',
              path: 'tilastotSivu',
