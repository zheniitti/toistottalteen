                                                            ...
                                                            InkWell(
                                                              onTap: () async {
                                                                ...
                                                                if (loggedIn) {
                                                                  ...
                                                                  context.pushNamedAuth('paasivuWithPageview', mounted);
                                                                }
                                                              },
                                                              child: Container(
                                                                width: 60.0,
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (true) {
                                                        ...
                                                        final usersUpdateData = {
                                                          ...
                                                          if (FFAppState().anonymouslyLoggedInUserAccountRef != null /* do not remove if */) 'anonymousAccounts': FieldValue.arrayUnion([FFAppState().anonymouslyLoggedInUserAccountRef]),
                                                        };
                                                        await currentUserReference!.update(usersUpdateData);
