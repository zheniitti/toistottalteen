                          ...
                          Container(
                            ...
                            child: PageView(
                              ...
                              onPageChanged: (_) async {
                                ...
                                setState(() {
                                  FFAppState().navBarIndex = _model.pageViewController?.page?.round() ?? 0;
                                });
                              },
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () async {
                                                logFirebaseEvent('PAASIVU_WITH_PAGEVIEW_Container_5u6of3wp');
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                logFirebaseEvent('PAASIVU_WITH_PAGEVIEW_Container_6ui38rel');
                                                logFirebaseEvent('Container_widget_animation');
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                logFirebaseEvent('PAASIVU_WITH_PAGEVIEW_Container_8xnhzvl5');
                                                logFirebaseEvent('Container_widget_animation');
                                            ...
                                            if (false)
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent('PAASIVU_WITH_PAGEVIEW_Container_h3ck4imk');
                                                  logFirebaseEvent('Container_widget_animation');
                                                  if (animationsMap['containerOnActionTriggerAnimation4'] != null) {
                                                    animationsMap['containerOnActionTriggerAnimation4']!.controller.forward(from: 0.0).whenComplete(animationsMap['containerOnActionTriggerAnimation4']!.controller.reverse);
                                                  }
                                                  logFirebaseEvent('Container_update_app_state');
                                                  FFAppState().update(() {
                                                ...
                                                child: Container(
                                                  width: 100,
                                                  decoration: BoxDecoration(
                                                    color: FFAppState().navBarIndex == 3 ? FlutterFlowTheme.of(context).tertiary : Color(0x00000000),
                                                    borderRadius: BorderRadius.circular(8),
                                                  ),
                                                  child: Column(
                                                    mainAxisSize: MainAxisSize.max,
