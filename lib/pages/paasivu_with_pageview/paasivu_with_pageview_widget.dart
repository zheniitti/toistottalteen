...
class _PaasivuWithPageviewWidgetState extends State<PaasivuWithPageviewWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('paasivuWithPageview_start_periodic_actio');
                          ...
                          Container(
                            ...
                            child: PageView(
                              ...
                              onPageChanged: (_) async {
                                logFirebaseEvent(
                                    'PAASIVU_WITH_PAGEVIEW_PageView_1ws0twx1_');
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: InkWell(
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'PAASIVU_WITH_PAGEVIEW_Icon_8kd9qxtw_ON_T');
                                                          logFirebaseEvent(
                                                              'Icon_backend_call');
                                                          await containerQueryLatestSessioTreeniSessiotRecordList
                                                              .first.reference
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PAASIVU_WITH_PAGEVIEW_Container_xsfpwyl4');
                                                logFirebaseEvent(
