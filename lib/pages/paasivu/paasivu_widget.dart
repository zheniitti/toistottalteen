                                                    ...
                                                    if (containerQueryLatestSessioTreeniSessiotRecordList
                                                      ...
                                                      InkWell(
                                                        onTap: () async {
                                                          ...
                                                          logFirebaseEvent(
                                                              'Row_aloitaAjanOtto_lottie_animation');
                                                          setState(() => _model
                                                                  .lottieAnimationStatus =
                                                              true);
                                                        },
                                                        child: Row(
                                                          mainAxisSize:
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      await currentUserReference!
                                                          .update(
                                                              usersUpdateData);
                                                      logFirebaseEvent(
                                                          'Row_lopetaTreeni_lottie_animation');
                                                      setState(() => _model
                                                              .lottieAnimationStatus =
                                                          !_model
                                                              .lottieAnimationStatus);
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PAASIVU_PAGE_Container_bivk72cl_ON_TAP');
                                          logFirebaseEvent(
                                      ...
                                      InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PAASIVU_PAGE_Container_yz7cjr7k_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_widget_animation');
                                          if (animationsMap[
                                      ...
                                      InkWell(
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PAASIVU_PAGE_Container_3jdtl8g9_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_widget_animation');
                                          if (animationsMap[
                                      ...
                                      if (false)
                                        InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PAASIVU_PAGE_Container_7zat7ekl_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_widget_animation');
                                            if (animationsMap[
