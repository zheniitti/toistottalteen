...
class _RutiininLiikkeetWidgetState extends State<RutiininLiikkeetWidget> with TickerProviderStateMixin {
                ...
                children: [
                  if (!widget.rutiini!.finishedEditing!)
                    Padding(
                      ...
                      ).animateOnPageLoad(animationsMap['iconOnPageLoadAnimation']!).animateOnActionTrigger(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      logFirebaseEvent('RUTIININ_LIIKKEET_Column_fzb56clx_ON_TAP');
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text: liikkeetItem.aloitusPainoKg!.toString(),
                                                  style: FlutterFlowTheme.of(context).bodyText1.override(
                                                        fontFamily: 'Roboto',
                                                        fontWeight: FontWeight.w500,
                                                      ),
