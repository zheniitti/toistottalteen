...
(tulossa) */
                              ...
                              Padding(
                                ...
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if ((widget.latestSessioStreamDoc !=
                                            null) &&
                                        (widget.latestSessioStreamDoc == null))
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 30.0),
                                        child: wrapWithModel(
                                          ...
                                          updateOnChange: true,
                                          child:
                                              KeskenerainenTreeniKomponenttiWidget(
                                            sessio:
                                                widget.latestSessioStreamDoc,
                                          ),
                                        ),
                                      ),
                                    if (containerTreeniSessiotRecordList
                                            .length >=
                                        1)
