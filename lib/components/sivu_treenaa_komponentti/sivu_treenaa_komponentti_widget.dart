        ...
        children: [
          if (valueOrDefault<bool>(
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 240.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        Padding(
                                    ...
                                    children: [
                                      TextFormField(
                                        ...
                                        onChanged: (_) => EasyDebounce.debounce(
                                          ...
                                          () async {
                                            logFirebaseEvent('SIVU_TREENAA_KOMPONENTTI_rutiininnimi_ON');
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          contentPadding: EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 4.0),
                                        ),
                                      ...
                                      TextFormField(
                                        ...
                                        onChanged: (_) => EasyDebounce.debounce(
                                          ...
                                          Duration(milliseconds: 1000),
                                          () async {
                                            logFirebaseEvent('SIVU_TREENAA_KOMPONENTTI_rutiiniKommentt');
                                            logFirebaseEvent('rutiiniKommentti_custom_action');
                                            _model.updatedRutiiniFromKommenttiField = await actions.myUpdateTreeniRutiiniStruct(
                                              widget.sessioDoc!.treeniRutiiniData,
                                              null,
                                              _model.rutiininnimiController.text,
                                              widget.sessioDoc!.treeniRutiiniData.liikkeet?.toList()?.toList(),
          ...
          if (!(isWeb ? MediaQuery.of(context).viewInsets.bottom > 0 : _isKeyboardVisible))
            Align(
              alignment: AlignmentDirectional(0.0, 1.0),
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 108.0),
                child: InkWell(
                  onTap: () async {
                    ...
                    logFirebaseEvent('Container_painike_uusiLiike_custom_actio');
                    await actions.updateTreenisessiotRecord(widget.sessioDoc, null, null, _model.updatedRutiiniFromLisaaLiike, null, null, false);
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.createdSessioDoc = TreeniSessiotRecord.getDocumentFromData(treeniSessiotCreateData, treeniSessiotRecordReference);
