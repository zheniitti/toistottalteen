...
class GetStartedSivuModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Custom Action - getPlatformAsString] action in Button_uusi widget.
  String? platformString;
  // Stores action output result for [Backend Call - Create Document] action in Button_uusi widget.
